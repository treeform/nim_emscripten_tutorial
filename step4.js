...
// include: /var/folders/nh/hbz5f40j1nb0m6t1hnbbz8q40000gn/T/tmpi4df52dx.js
...
(() => {
  ...
  async function loadPackage(metadata) {
    ...
    var PACKAGE_NAME = "step4.data";
    var REMOTE_PACKAGE_BASE = "step4.data";
    ...
    async function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_step4.data");
      }
      Module["addRunDependency"]("datafile_step4.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/data/IBMPlexSans-Bold.ttf",
      "start": 0,
      "end": 186504
    }, {
      "filename": "/data/IBMPlexSans-Regular.ttf",
      "start": 186504,
      "end": 372864
    }, {
      "filename": "/data/bg.png",
      "start": 372864,
      "end": 432777
    }, {
      "filename": "/data/frag.emscripten.sh",
      "start": 432777,
      "end": 432903
    }, {
      "filename": "/data/frag.sh",
      "start": 432903,
      "end": 433006
    }, {
      "filename": "/data/ring1.png",
      "start": 433006,
      "end": 440182
    }, {
      "filename": "/data/ring2.png",
      "start": 440182,
      "end": 448613
    }, {
      "filename": "/data/ring3.png",
      "start": 448613,
      "end": 458091
    }, {
      "filename": "/data/vert.emscripten.sh",
      "start": 458091,
      "end": 458274
    }, {
      "filename": "/data/vert.sh",
      "start": 458274,
      "end": 458434
    } ],
    "remote_package_size": 458434
  });
})();

// end include: /var/folders/nh/hbz5f40j1nb0m6t1hnbbz8q40000gn/T/tmpi4df52dx.js
// include: /var/folders/nh/hbz5f40j1nb0m6t1hnbbz8q40000gn/T/tmpahd8u849.js
...
// end include: /var/folders/nh/hbz5f40j1nb0m6t1hnbbz8q40000gn/T/tmpahd8u849.js
// include: /var/folders/nh/hbz5f40j1nb0m6t1hnbbz8q40000gn/T/tmp0_u9kaip.js
...
// end include: /var/folders/nh/hbz5f40j1nb0m6t1hnbbz8q40000gn/T/tmp0_u9kaip.js
var arguments_ = [];
...
function __mmap_js(len, prot, flags, fd, offset, allocated, addr) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(9, 0, 1, len, prot, flags, fd, offset, allocated, addr);
...
function __munmap_js(addr, len, prot, flags, fd, offset) {
  if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(10, 0, 1, addr, len, prot, flags, fd, offset);
  offset = bigintToI53Checked(offset);
  try {
    var stream = SYSCALLS.getStreamFromFD(fd);
    if (prot & 2) {
...
var proxiedFunctionTable = [ _proc_exit, exitOnMainThread, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_newfstatat, ___syscall_openat, ___syscall_stat64, __mmap_js, __munmap_js, _emscripten_set_blur_callback_on_thread, _emscripten_set_focus_callback_on_thread, _emscripten_set_keydown_callback_on_thread, _emscripten_set_keypress_callback_on_thread, _emscripten_set_keyup_callback_on_thread, _emscripten_set_mousedown_callback_on_thread, _emscripten_set_mousemove_callback_on_thread, _emscripten_set_mouseup_callback_on_thread, _emscripten_set_wheel_callback_on_thread, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
function make_canvas_focusable() {
  Module.canvas.tabIndex = 1;
  Module.canvas.focus();
}

function setup_resize_observer(userData) {
...
function assignWasmImports() {
  wasmImports = {
    ...
    /** @export */ make_canvas_focusable,
    /** @export */ memory: wasmMemory,
    /** @export */ set_canvas_size,
    /** @export */ setup_resize_observer
  };
}
